:- module(location_model,
    [create_location_model/3, clear_location/1, get_location_grid_x/2, get_location_grid_y/2,get_location_neighbors/2, get_location_orthogonal_neighbors/2, get_location_by_last_tile_placed/2,
     ...
     location_edge_neighbor_position/4, location_edge_neighbor_tile/3, location_edge_second_neighbor_tile/3, point_in_location/3, location_model_values/2]).
